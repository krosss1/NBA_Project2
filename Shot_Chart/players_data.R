players_url = "https://stats.nba.com/stats/commonallplayers?LeagueID=00&Season=2018-19&IsOnlyCurrentSeason=0"
...
if (Sys.Date() <= as.Date("2017-10-20")) {
  players = mutate(players, to_year = pmin(to_year, 2017))
}
...
default_player = find_player_by_name("Nikola Jokic")
